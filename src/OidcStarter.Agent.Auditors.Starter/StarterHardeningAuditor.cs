...
public sealed class StarterHardeningAuditor : IAuditor
{
    ...
    public StarterHardeningAuditor()
        ...
        [
            ...
            new BffAuthorizationCodeFlowRule(),
            ...
            new MinimalFrontendClaimsExposureRule(),
            ...
            new UnauthorizedForbiddenBehaviorTestsRule(),
            new PackageSampleCompatibilityTestsRule(),
